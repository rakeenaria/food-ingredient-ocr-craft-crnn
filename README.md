...
| Stage | Asset |
|---|---|
| Input image | `bahan/bahan_1.png` (available sample) |
| CRAFT detected regions | `outputs/examples/detected_regions.jpg` (placeholder slot) |
| Final OCR reconstruction | `outputs/examples/ocr_output.txt` (placeholder slot) |
